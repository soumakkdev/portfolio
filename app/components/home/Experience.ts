...
void main() {
	...
	for(int i=0; i< 5; i++) {
		...
		vec3 gradient = mix(vec3(0.077, 0.077, 0.078), vec3(0.220, 0.333, 0.956), n );

		vColor = vec3(gradient);
	}
...
void main() {
    ...
    gl_FragColor = vec4(vColor, 1.0);  // Basic gradient based on UV
}
`
...
export class Experience {
	...
	setup() {
		...
		this.plane = new THREE.Mesh(
			new THREE.PlaneGeometry(5, 5, 1000, 1000),
