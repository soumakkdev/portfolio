		...
		<div className="max-w-6xl mx-auto px-6 relative">
			<div className="max-w-4xl  my-20">
				...
				<p className="lg:text-xl leading-relaxed mb-12 text-muted-foreground">
					I’m Soumak, a frontend developer based in India, specializing in creating visually appealing and highly functional web
					experiences. With a keen eye for design, I bring both creativity and precision to every project.
				</p>
